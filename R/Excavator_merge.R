...
#' @export
#'
#' @examples Excavator_merge_bed(my_file_path_target_bed, my_file_path_HSLM, ,my_merged_file_name = "merged_data.txt")
...
HSLM <- utls::read.table(file_path_HSLM, fill=T, quote="\"", sep="\t", h = T) 
...
utils::write.table(merge_data, file_path_output, quote = FALSE, row.names = TRUE, sep = "\t")  
}
